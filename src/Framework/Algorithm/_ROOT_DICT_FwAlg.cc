...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::genie::AlgFactory*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("genie::AlgFactory", "AlgFactory.h", 40,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::genie::AlgConfigPool*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("genie::AlgConfigPool", "", 418,
...
"/grid/fermiapp/products/larsoft/root/v6_12_06a/Linux64bit+3.10-2.17-e17-debug/include",
"/genie/app/users/kborah/Generator/src/Framework/Algorithm/",
0
    };
...
namespace genie{class __attribute__((annotate("$clingAutoload$Framework/Algorithm/AlgStatus.h")))  AlgStatus;}
namespace genie{class __attribute__((annotate("$clingAutoload$Framework/Algorithm/AlgCmp.h")))  AlgCmp;}
namespace genie{class __attribute__((annotate("$clingAutoload$Framework/Algorithm/AlgFactory.h")))  AlgFactory;}
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("libGFwAlg",
        ...
        TriggerDictionaryInitialization_libGFwAlg_Impl, {}, classesHeaders);
      isInitialized = true;
    }
  }
