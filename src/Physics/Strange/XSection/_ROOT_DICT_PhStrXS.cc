...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::genie::AlamSimoAtharVacasSKXSec*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("genie::AlamSimoAtharVacasSKXSec", "", 40,
   ...
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::genie::AlamSimoAtharVacasSKXSec*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *geniecLcLAlamSimoAtharVacasSKXSec_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const ::genie::AlamSimoAtharVacasSKXSec*)0x0)->GetClass();
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::genie::utils::gsl::d3Xsec_dTldTkdCosThetal*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("genie::utils::gsl::d3Xsec_dTldTkdCosThetal", "", 70,
   ...
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::genie::utils::gsl::d3Xsec_dTldTkdCosThetal*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *geniecLcLutilscLcLgslcLcLd3Xsec_dTldTkdCosThetal_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const ::genie::utils::gsl::d3Xsec_dTldTkdCosThetal*)0x0)->GetClass();
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::genie::AlamSimoAtharVacasSKPXSec2014*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("genie::AlamSimoAtharVacasSKPXSec2014", "", 121,
   ...
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::genie::AlamSimoAtharVacasSKPXSec2014*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *geniecLcLAlamSimoAtharVacasSKPXSec2014_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const ::genie::AlamSimoAtharVacasSKPXSec2014*)0x0)->GetClass();
...
namespace ROOT {
   ...
   static void *new_geniecLcLPaisQELLambdaPXSec(void *p = 0);
   ...
   {
      return GenerateInitInstanceLocal((::genie::PaisQELLambdaPXSec*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::genie::PaisQELLambdaPXSec*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *geniecLcLPaisQELLambdaPXSec_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const ::genie::PaisQELLambdaPXSec*)0x0)->GetClass();
...
namespace ROOT {
   ...
   // Wrapper around operator delete
   static void delete_geniecLcLPaisQELLambdaPXSec(void *p) {
      delete ((::genie::PaisQELLambdaPXSec*)p);
   }
   static void deleteArray_geniecLcLPaisQELLambdaPXSec(void *p) {
      delete [] ((::genie::PaisQELLambdaPXSec*)p);
   }
...
"/grid/fermiapp/products/larsoft/root/v6_12_06a/Linux64bit+3.10-2.17-e17-debug/include",
"/genie/app/users/kborah/Generator/src/Physics/Strange/XSection/",
0
    };
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("libGPhStrXS",
        ...
        TriggerDictionaryInitialization_libGPhStrXS_Impl, {}, classesHeaders);
      isInitialized = true;
    }
  }
